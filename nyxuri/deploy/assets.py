...
from nyxuri.constants import Colors, WALLPAPER_MIRRORS
from nyxuri.core import get_env, get_pics_dir, log_msg, register_temp_path
from nyxuri.i18n import msg
from nyxuri.network import git_clone_timeout
...
def deploy_wallpapers(do_download: bool = False) -> WallpaperDeployResult:
    ...
    downloaded = False
    managed: set[str] = set()
    marker_path = wp_dest / ".nyxuri-managed.json"
    ...
    if managed:
        (wp_dest / ".nyxuri-managed.json").write_text(
